...
func (o *DeleteTypeURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on DeleteTypeURL")
	}
...
func (o *DeleteTypeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTypeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTypeURL")
	}
